...
const schema = z.object ({
    ...
    email: z.string().email({message: "Please enter valid email address"}).min(),
    password: z.string().min(8 , {message: "Password must be at least 8 characters long"}) ,
    cpassword: z.string(),
    address: z.string().min(15 , {message: "Address must be at least 15 characters long"}),
}).refine(data => data.password === data.cpassword , {message: "Password does not match" , path: ["cpassword"]
})
        ...
        <section className='align_center form_page'>
            <form className='authentication_form signup_form' onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='form_inputs signup_form_input'>
                    ...
                    {errors.cpassword && (<em className="form_error">{errors.cpasswrd.message}</em>)}
